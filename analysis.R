...
pairs(tlx[,7:12], pch = 19, col=my_cols[tlx$experimentID],main="NASA-TLX Results per Condition",oma=c(4,4,6,12))
par(xpd=TRUE)
legend(0.90, 0.7, c("Paper","VR"),cex=.8,col=my_cols,pch=19)
...
pairs(tlx_2[,9:14], pch = 19, col=my_cols_2[tlx_2$experimentID],main="NASA-TLX Results per Condition",oma=c(4,4,6,12))
par(xpd=TRUE)
legend(0.90, 0.7, c("Paper","VR"),cex=.8,col=my_cols_2,pch=19)
